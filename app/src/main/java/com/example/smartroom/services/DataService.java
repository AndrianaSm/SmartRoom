...
public class DataService {
    ...
    public ArrayList<Person> getPersons () {
        ...
        list.add(new Person("A","Ανδριάνα",22,"avatar_one", getBloodSugarMeasurements("A")));
        list.add(new Person("B","Σπύρος",55,"avatar_two", getBloodSugarMeasurements("B")));
        list.add(new Person("C","Αιμιλία",22,"avatar_three", getBloodSugarMeasurements("C")));
        return list;
    }
    ...
    public ArrayList<BloodSugar> getBloodSugarMeasurements(String id) {
        ...
        if(id.equals("A")){
            ...
            list.add(new BloodSugar("11/01/2021","07:03", "101"));
            list.add(new BloodSugar("12/01/2021", "08:32", "101"));
            list.add(new BloodSugar("13/01/2021", "07:43", "122"));
            list.add(new BloodSugar("14/01/2021", "07:43", "123"));
            list.add(new BloodSugar("15/01/2021", "07:34", "99"));
            list.add(new BloodSugar("16/01/2021", "07:40", "140"));
            list.add(new BloodSugar("17/01/2021", "07:30", "110"));
            list.add(new BloodSugar("18/01/2021", "08:06", "150"));
        }
        return list;
    }
